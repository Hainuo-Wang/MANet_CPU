...
class B_Model(BaseModel):
    def __init__(self, opt):
        ...
        self.netG = networks.define_G(opt).to("cpu")
        if opt['dist']:
    ...
    def feed_data(self, data, LR_img, LR_n_img, ker_map, kernel):
        self.real_H = data['GT'].to("cpu")  # GT
        self.var_L, self.var_LN, self.ker_map, self.real_K = LR_img.to("cpu"), LR_n_img.to(
            "cpu"), ker_map.to("cpu"), kernel.to("cpu")
